...
if pagina_seleccionada == 'Inicio':
    ...
    col1.image("foto.jpeg", caption='Hola, soy Ninoska Montero Callan', width=300)
    ...
    # Agregamos un título
    st.markdown("<h1 style='text-align: center;'>Recap de mi sufrimiento aprendiendo a programar💻</h1>", unsafe_allow_html=True)
    ...
    st.markdown("<h2 style='text-align: center;'>Mini tutorial, aún cuando yo estaba más perdida</h2>", unsafe_allow_html=True)
    ...
    st.markdown(f"<div style='text-align: center;'><a href='https://drive.google.com/file/d/1Vl3FZBNOsP4ed1KxwTZuDbGnoWcMg9Hk/view?usp=sharing' target='_blank'><button>Ver video</button></a></div>", unsafe_allow_html=True) 
